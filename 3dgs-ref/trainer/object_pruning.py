...
def parse_args() -> argparse.Namespace:
    ...
    gaussian_parser.add_argument("--min-front-inside-views", type=int, default=2)
    gaussian_parser.add_argument("--min-front-inside-ratio", type=float, default=0.05)
    gaussian_parser.add_argument("--min-front-visible-views", type=int, default=4)
    gaussian_parser.add_argument("--depth-margin-scale", type=float, default=2.5)
    ...
    gaussian_parser.add_argument("--spatial-neighbor-threshold", type=int, default=10)
    gaussian_parser.add_argument("--spatial-min-component-points", type=int, default=128)
    gaussian_parser.add_argument("--spatial-component-keep-ratio", type=float, default=0.03)
